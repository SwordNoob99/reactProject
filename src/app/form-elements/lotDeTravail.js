...
export class lotDeTravail extends Component {
  state = {
    startDate: new Date()
  };
    ...
    return (
      <div>
        <div className="page-header">
          <h3 className="page-title"> Add lot de travail </h3>
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb">
              <li className="breadcrumb-item"><a href="!#" onClick={event => event.preventDefault()}>basic features</a></li>
              <li className="breadcrumb-item active" aria-current="page">lot de travail</li>
            </ol>
          </nav>
        </div>
        <div className="row">
          ...
          <div className="col-12 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">lot de travail</h4>
